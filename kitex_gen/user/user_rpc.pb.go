...
func (x *User) Reset() {
	*x = User{}
	if protoimpl.UnsafeEnabled {
		mi := &file_idl_user_rpc_proto_msgTypes[0]
...
func (*User) Descriptor() ([]byte, []int) {
	return file_idl_user_rpc_proto_rawDescGZIP(), []int{0}
}
...
func (x *DouyinUserRegisterRequest) Reset() {
	*x = DouyinUserRegisterRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_idl_user_rpc_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*DouyinUserRegisterRequest) Descriptor() ([]byte, []int) {
	return file_idl_user_rpc_proto_rawDescGZIP(), []int{1}
}
...
func (x *DouyinUserRegisterResponse) Reset() {
	*x = DouyinUserRegisterResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_idl_user_rpc_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*DouyinUserRegisterResponse) Descriptor() ([]byte, []int) {
	return file_idl_user_rpc_proto_rawDescGZIP(), []int{2}
}
...
func (x *DouyinUserLoginRequest) Reset() {
	*x = DouyinUserLoginRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_idl_user_rpc_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*DouyinUserLoginRequest) Descriptor() ([]byte, []int) {
	return file_idl_user_rpc_proto_rawDescGZIP(), []int{3}
}
...
func (x *DouyinUserLoginResponse) Reset() {
	*x = DouyinUserLoginResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_idl_user_rpc_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*DouyinUserLoginResponse) Descriptor() ([]byte, []int) {
	return file_idl_user_rpc_proto_rawDescGZIP(), []int{4}
}
...
func (x *DouyinUserRequest) Reset() {
	*x = DouyinUserRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_idl_user_rpc_proto_msgTypes[5]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*DouyinUserRequest) Descriptor() ([]byte, []int) {
	return file_idl_user_rpc_proto_rawDescGZIP(), []int{5}
}
...
func (x *DouyinUserResponse) Reset() {
	*x = DouyinUserResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_idl_user_rpc_proto_msgTypes[6]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*DouyinUserResponse) Descriptor() ([]byte, []int) {
	return file_idl_user_rpc_proto_rawDescGZIP(), []int{6}
}
...
var File_idl_user_rpc_proto protoreflect.FileDescriptor

var file_idl_user_rpc_proto_rawDesc = []byte{
	0x0a, 0x12, 0x69, 0x64, 0x6c, 0x2f, 0x75, 0x73, 0x65, 0x72, 0x5f, 0x72, 0x70, 0x63, 0x2e, 0x70,
	0x72, 0x6f, 0x74, 0x6f, 0x12, 0x04, 0x75, 0x73, 0x65, 0x72, 0x22, 0xe1, 0x02, 0x0a, 0x04, 0x55,
	...
	0x0d, 0x66, 0x61, 0x76, 0x6f, 0x72, 0x69, 0x74, 0x65, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x22, 0x53,
	...
	0x65, 0x6e, 0x22, 0x74, 0x0a, 0x12, 0x44, 0x6f, 0x75, 0x79, 0x69, 0x6e, 0x55, 0x73, 0x65, 0x72,
	...
	0x65, 0x72, 0x52, 0x04, 0x75, 0x73, 0x65, 0x72, 0x32, 0xeb, 0x01, 0x0a, 0x0b, 0x55, 0x73, 0x65,
	0x72, 0x48, 0x61, 0x6e, 0x64, 0x6c, 0x65, 0x72, 0x12, 0x3b, 0x0a, 0x04, 0x55, 0x73, 0x65, 0x72,
	0x12, 0x17, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x2e, 0x44, 0x6f, 0x75, 0x79, 0x69, 0x6e, 0x55, 0x73,
	...
	0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x53, 0x0a, 0x0c, 0x55, 0x73, 0x65, 0x72, 0x52, 0x65, 0x67,
	0x69, 0x73, 0x74, 0x65, 0x72, 0x12, 0x1f, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x2e, 0x44, 0x6f, 0x75,
	0x79, 0x69, 0x6e, 0x55, 0x73, 0x65, 0x72, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74, 0x65, 0x72, 0x52,
	0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x20, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x2e, 0x44, 0x6f,
	0x75, 0x79, 0x69, 0x6e, 0x55, 0x73, 0x65, 0x72, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74, 0x65, 0x72,
	0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x4a, 0x0a, 0x09, 0x55, 0x73,
	0x65, 0x72, 0x4c, 0x6f, 0x67, 0x69, 0x6e, 0x12, 0x1c, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x2e, 0x44,
	...
	0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x42, 0x18, 0x5a, 0x16, 0x67, 0x61, 0x74, 0x65, 0x77, 0x61,
	0x79, 0x2f, 0x6b, 0x69, 0x74, 0x65, 0x78, 0x5f, 0x67, 0x65, 0x6e, 0x2f, 0x75, 0x73, 0x65, 0x72,
	0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}

var (
	file_idl_user_rpc_proto_rawDescOnce sync.Once
	file_idl_user_rpc_proto_rawDescData = file_idl_user_rpc_proto_rawDesc
)

func file_idl_user_rpc_proto_rawDescGZIP() []byte {
	file_idl_user_rpc_proto_rawDescOnce.Do(func() {
		file_idl_user_rpc_proto_rawDescData = protoimpl.X.CompressGZIP(file_idl_user_rpc_proto_rawDescData)
	})
	return file_idl_user_rpc_proto_rawDescData
}

var file_idl_user_rpc_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_idl_user_rpc_proto_goTypes = []interface{}{
...
var file_idl_user_rpc_proto_depIdxs = []int32{
...
func init() { file_idl_user_rpc_proto_init() }
func file_idl_user_rpc_proto_init() {
	if File_idl_user_rpc_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_idl_user_rpc_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*User); i {
			case 0:
				return &v.state
			case 1:
		...
		file_idl_user_rpc_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_idl_user_rpc_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_idl_user_rpc_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_idl_user_rpc_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_idl_user_rpc_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
		...
		file_idl_user_rpc_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_idl_user_rpc_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   7,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_idl_user_rpc_proto_goTypes,
		DependencyIndexes: file_idl_user_rpc_proto_depIdxs,
		MessageInfos:      file_idl_user_rpc_proto_msgTypes,
	}.Build()
	File_idl_user_rpc_proto = out.File
	file_idl_user_rpc_proto_rawDesc = nil
	file_idl_user_rpc_proto_goTypes = nil
	file_idl_user_rpc_proto_depIdxs = nil
}
